...
/**@brief Add Tag Status Serial Number Characteristic to the Service.
*/
void nrf51_tag_status_serial_number_char_add(ble_tag_status_service_t* p_tag_status_service)
{
    ...
    ble_uuid.type = p_tag_status_service->uuid_type;
    ble_uuid.uuid = BLE_UUID_TAG_STATUS_SERIAL_NUMBER_CHAR;
    ...
    ble_tag_status_serial_number_t tag_status_serial_number = {0};

    attr_char_value.p_uuid    = &ble_uuid;
    attr_char_value.p_attr_md = &attr_md;
    attr_char_value.init_len  = sizeof(tag_status_serial_number);
    attr_char_value.init_offs = 0;
    attr_char_value.max_len   = sizeof(tag_status_serial_number);
    attr_char_value.p_value   = (uint8_t*)&tag_status_serial_number;
    ...
    (
        ...
        &char_md,
        &attr_char_value,
        &p_tag_status_service->tag_status_serial_number_char_handles
    );
    
    APP_ERROR_CHECK(err_code);
}

/**@brief Add Tag Status Buzzer Characteristic to the Service.
*/
void nrf51_tag_status_buzzer_char_add(ble_tag_status_service_t* p_tag_status_service)
{
    ...
    ble_uuid.type = p_tag_status_service->uuid_type;
    ble_uuid.uuid = BLE_UUID_TAG_STATUS_BUZZER_CHAR;
    ...
    ble_tag_status_buzzer_t tag_status_buzzer = {0};

    attr_char_value.p_uuid    = &ble_uuid;
    attr_char_value.p_attr_md = &attr_md;
    attr_char_value.init_len  = sizeof(tag_status_buzzer);
    attr_char_value.init_offs = 0;
    attr_char_value.max_len   = sizeof(tag_status_buzzer);
    attr_char_value.p_value   = (uint8_t*)&tag_status_buzzer;
    ...
    (
        ...
        &char_md,
        &attr_char_value,
        &p_tag_status_service->tag_status_buzzer_char_handles
    );
