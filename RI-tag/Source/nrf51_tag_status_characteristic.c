...
void nrf51_tag_status_beacon_record_count_char_add(ble_tag_status_service_t* p_tag_status_service)
{
    ...
    ble_tag_status_beacon_record_count_t tag_status_beacon_record_count = {0};

    attr_char_value.p_uuid    = &ble_uuid;
    attr_char_value.p_attr_md = &attr_md;
    attr_char_value.init_len  = sizeof(tag_status_beacon_record_count);
    attr_char_value.init_offs = 0;
    attr_char_value.max_len   = sizeof(tag_status_beacon_record_count);
    attr_char_value.p_value   = (uint8_t*)&tag_status_beacon_record_count;
    ...
    (
        ...
        &char_md,
        &attr_char_value,
        &p_tag_status_service->tag_status_beacon_record_count_char_handles
    );
    
    APP_ERROR_CHECK(err_code);
}

/**@brief Add Tag Status Beacon Read Records Characteristic to the Service.
*/
void nrf51_tag_status_beacon_read_records_char_add(ble_tag_status_service_t* p_tag_status_service)
{
    ...
    ble_tag_status_beacon_read_records_t tag_status_beacon_read_records = {0};

    attr_char_value.p_uuid    = &ble_uuid;
    attr_char_value.p_attr_md = &attr_md;
    attr_char_value.init_len  = sizeof(tag_status_beacon_read_records);
    attr_char_value.init_offs = 0;
    attr_char_value.max_len   = sizeof(tag_status_beacon_read_records);
    attr_char_value.p_value   = (uint8_t*)&tag_status_beacon_read_records;
    ...
    (
        ...
        &char_md,
        &attr_char_value,
        &p_tag_status_service->tag_status_beacon_read_records_char_handles
    );
...
void nrf51_tag_status_activity_read_records_char_add(ble_tag_status_service_t* p_tag_status_service)
{
    ...
    attr_char_value.p_uuid    = &ble_uuid;
    attr_char_value.p_attr_md = &attr_md;
    attr_char_value.init_len  = sizeof(tag_status_activity_read_records);
    attr_char_value.init_offs = 0;
    attr_char_value.max_len   = sizeof(tag_status_activity_read_records);
    attr_char_value.p_value   = (uint8_t*)&tag_status_activity_read_records;
