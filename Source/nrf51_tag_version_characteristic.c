...
*/
void nrf51_tag_debug_char_add(ble_tag_debug_t* p_tag_debug)
{
    ...
    ble_uuid.type = p_tag_debug->uuid_type;
    ...
    // Add Tag Debug Characteristic
    // Note: Populates the tag_debug_cmd_char_handles field 
    //
    err_code = sd_ble_gatts_characteristic_add
    (
        p_tag_debug->service_handle, 
        &char_md,
        &attr_char_value,
        &p_tag_debug->tag_debug_cmd_char_handles
    );
